...
contract UserSide_Healthcare{
    ...
    address public admin2 = 0x4F53d589FE623aF6D0dc3ccA612C2F35F64d3cb9;
    address public admin3 = 0xc35fC43ae078961BfC34FfB6c2148571b6f87920;
    ...
    function approveUser(uint256 _userId) public {
        require(msg.sender == admin1 || msg.sender == admin2 || msg.sender == admin3,"Only Admin can call this function");
